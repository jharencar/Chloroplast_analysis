...
```
# BAD - some samples are missing more than 75% data, several somehow missing everything... I need to remove these I think! maybe even remove samples missing more than like, 25%... 
...
$VCF_OUT
```
Now, we have a final, filtered output vcf: chloroplast_w.outgroups_filtered.vcf.gz